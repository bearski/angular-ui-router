...
(function(v) {
    ...
    function tc(a, b) {
        ...
        return !E(b) || b instanceof RegExp ? b : d.length ? function() {
            return arguments.length ? b.apply(a, $a(d, arguments, 0)) : b.apply(a, d) } : function() {
            return arguments.length ? b.apply(a, arguments) : b.call(a) } }

    function be(a, b) {
        var d = b; "string" === typeof a && "$" === a.charAt(0) && "$" === a.charAt(1) ? d = void 0 : Va(b) ? d = "$WINDOW" : b && v.document === b ? d = "$DOCUMENT" : Ya(b) && (d = "$SCOPE");
        return d }
    ...
    function vc(a, b) { a = a.replace(ce, "");
        var d = Date.parse("Jan 01, 1970 00:00:00 " + a) / 6E4;
        return isNaN(d) ? b : d }

    function Qb(a, b, d) { d = d ? -1 : 1;
    ...
    function ge(a) { a = ea.element(a).injector();
        if (!a) throw Aa("test");
    ...
    function cb(a) {
        return a.replace(If,
            function(a, d, c, e) {
                return e ? c.toUpperCase() : c }).replace(Jf, "Moz$1")
    }
    ...
    function Bb(a, b) { b || ub(a);
        var d = a.parentNode;
        d && d.removeChild(a) }

    function Of(a, b) { b = b || v;
    ...
    function Ff() { this.$get = function() {
            return R(U, { hasClass: function(a, b) { a.attr && (a = a[0]);
                    return xb(a, b) }, addClass: function(a, b) { a.attr && (a = a[0]);
                    return zb(a, b) }, removeClass: function(a, b) { a.attr && (a = a[0]);
                    return yb(a, b) } }) } }
    ...
    function Tc(a) { a = Function.prototype.toString.call(a).replace(Tf, "");
    ...
    function bb(a, b) {
        ...
        var k = {},
            ...
            r = m.$injector = h(m, function(a, b) { ea.isString(b) && l.push(b);
        ...
        k.url = function(b, d, e) {
            ...
            if (b) {
                ...
                if (!c.history || h && f) {
                    ...
                    l.href !== b && (u = b) } else n[d ? "replaceState" : "pushState"](e, "", b), g(), H = p;
                return k }
    ...
    function cf() { this.$get = ["$window", "$log", "$sniffer", "$document", function(a, b, d, c) {
    ...
    function zf() { this.$get = ["$cacheFactory", function(a) {
            return a("templates") }] }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, n, t, z, u, I, J, D) {
            ...
            function x(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                    ...
                    case 8:
                        try {
                            if (k = f.exec(a.nodeValue)) l = xa(k[1]), la(b, l, "M", d, e) && (c[l] = V(k[2])) } catch (J) {}
                }
                b.sort(Y);
                return b
            }
            ...
            function Xc(a, b, c) {
                return function(d, e, f, g, h) { e = Wc(e[0], b, c);
                    return a(d, e, f, g, h) } }
            ...
            function Ba(a, b, d, e, f, g, h, k, l) {
                ...
                function n(a, c, e, f, g) {
                    function l(a, b, c, d) {
                        ...
                        if (d) {
                            ...
                            if (y(f)) throw ga("noslot", d, wa(z)); } else return g(a, b, e, c, $) }
                    var m, t, p, A, w, u, L, z;
                ...
                for (var t = -Number.MAX_VALUE, r = l.newScopeDirective, I = l.controllerDirectives, D = l.newIsolateScopeDirective, J = l.templateDirective, w = l.nonTlbTranscludeDirective, u = !1, L = !1, H = l.hasElementTranscludeDirective, z = d.$$element = B(b), A, M, $, s = e, Sa, ka = !1, C = !1, v, F = 0, Ba = a.length; F < Ba; F++) {
                    ...
                    if (!ka && (A.replace && (A.templateUrl || A.template) || A.transclude && !A.$$tlb)) {
                        for (v = F + 1; ka = a[v++];)
                            if (ka.transclude && !ka.$$tlb || ka.replace && (ka.templateUrl || ka.template)) { C = !0;
                                break }
            ...
            function gb(a, b, c, d) {
                ...
                if (F(b)) {
                    ...
                    if (!e && !f) throw ga("ctreq", b, a); } else if (K(b))
                ...
                if (k) {
                    ...
                    c.push({
                        ...
                        compile: function() {
                            return {
                                pre: function(a,
                                    c, h) { c = h.$$observers || (h.$$observers = T());
                    ...
                    switch (e.mode) {
                        ...
                        case "=":
                            ...
                            D = r.literal ? pa : function(a, b) {
                                return a === b || a !== a && b !== b };
                            I = r.assign || function() { p = d[h] = r(a);
                                throw ga("nonassign", c[m], m, f.name); };
                            p = d[h] = r(a);
                            n = function(b) { D(b, d[h]) || (D(b, p) ? I(a, b = d[h]) : d[h] = b);
                                return p = b };
                            n.$stateful = !0;
        ...
        this.$get = ["$injector", "$window", function(d, c) {
            ...
            return function(f, g, h, k) {
                ...
                if (h) return h = (K(f) ? f[f.length - 1] : f).prototype, l = Object.create(h || null), m && e(g, m, l, n || f.name), R(function() {
                    ...
                    return l }, { instance: l, identifier: m });
    ...
    function ff() { this.$get = ["$window", function(a) {
            return B(a.document) }] }
    ...
    function dd(a) {
        ...
        F(a) ? q(a.split("\n"), function(a) { d = a.indexOf(":");
            ...
            a = V(a.substr(d + 1));
            e && (b[e] = b[e] ? b[e] + ", " + a : a) }) : G(a) && q(a, function(a, d) {
            var f = P(d),
                g = V(a);
            f && (b[f] = b[f] ? b[f] + ", " + g : g) });
        return b }
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, k, l) {
            function n(b) {
                ...
                d ? (h.success = function(a) { Pa(a, "fn");
                    ...
                    return h }, h.error = function(a) { Pa(a, "fn");
                    h.then(null, function(b) { a(b.data, b.status, b.headers, f) });
                    return h }) : (h.success = gd("success"), h.error = gd("error"));
                return h
            }
            ...
            n.pendingRequests = [];
            (function(a) { q(arguments, function(a) { n[a] = function(b, c) {
                        return n(R({}, c || {}, { method: a, url: b })) } }) })("get", "delete", "head", "jsonp");
    ...
    function pf() { this.$get = function() {
            return function() {
                return new v.XMLHttpRequest } } }

    function of() { this.$get = ["$browser", "$window", "$document", "$xhrFactory", function(a, b, d, c) {
        ...
        return function(e, h, k, l, n, m, r, N, M, w) {
            ...
            if ("jsonp" == P(e)) {
                ...
                c[t] = function(a) { c[t].data = a;
                    c[t].called = !0 };
                var z = f(h.replace("JSON_CALLBACK", "angular.callbacks." + t), t, function(a, b) { H(l, a, c[t].data, "", b);
                    c[t] = C }) } else {
                var u = b(e, h);
                u.open(e, h, !0);
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(d, c, e) {
            ...
            function k(f, k, m, r) {
                ...
                for (var L = [], S = []; I < t;)
                    ...
                    else { I !== t && L.push(g(f.substring(I)));
                        break }
                ...
                if (!k || J.length) {
                    ...
                    return R(function(a) {
                        ...
                        try {
                            for (; b < d; b++) e[b] = D[b](a);
                            return q(e) } catch (g) { c(Ja.interr(f, g)) } }, { exp: f, expressions: J, $$watchDelegate: function(a, b) {
                            var c;
    ...
    function qf() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function(d,
            ...
            var w = !0;
            c.onUrlChange(function(a, b) { y(na(N, a)) ? g.location.href = a : (d.$evalAsync(function() {
                    var c = l.absUrl(),
                        e = l.$$state,
                        f;
                    a = hb(a);
        ...
        this.$get = ["$filter", function(f) {
            ...
            function N(a, b) {
                ...
                var c = a.$$watchDelegate,
                    d = !1,
                    c = c !== m && c !== n ? function(c, e, f, g) { f = d && g ? g[0] : a(c, e, f, g);
    ...
    function uf() { this.$get = ["$rootScope", "$exceptionHandler", function(a, b) {
            return ud(function(b) { a.$evalAsync(b) }, b) }] }

    function vf() { this.$get = ["$browser", "$exceptionHandler", function(a, b) {
            ...
            n.prototype = {
                ...
                $watchCollection: function(a, b) {
                    ...
                    var d = this,
                        ...
                        p = !0,
                        t = 0;
                    return this.$watch(n, function() { p ? (p = !1, b(e, e, d)) : b(e, h, d);
                        if (k)
                            if (G(e))
                                if (ya(e)) { h = Array(e.length);
                ...
                $apply: function(a) {
                    try { m("$apply");
                        try {
                            return this.$eval(a) } finally { H.$$phase = null } } catch (b) { f(b) } finally {
    ...
    function xf() {
        ...
        var a = ["self"],
            b = [];
        this.resourceUrlWhitelist = function(b) { arguments.length && (a = wd(b));
            return a };
        this.resourceUrlBlacklist = function(a) { arguments.length && (b = wd(a));
            return b };
        this.$get = ["$injector",
            function(d) {
                function c(a, b) {
    ...
    function Af() {
        ...
        this.$get = ["$templateCache", "$http", "$q", "$sce", function(b, d, c, e) {
            function f(g, h) {
                ...
                return d.get(g,
                    R({ cache: b, transformResponse: k }, a))["finally"](function() { f.totalPendingRequests-- }).then(function(a) { b.put(g, a.data);
    ...
    q({ data: Wb, removeData: db, hasData: function(a) {
            ...
            for (var b = 0, d = a.length; b < d; b++) db(a[b]) } }, function(a, b) { U[b] = a });
    q({
        data: Wb,
        inheritedData: Ab,
        scope: function(a) {
    ...
    var Gf = [function() { this.$get = [function() {
                return Ra }] }],
        Uf = /^([^\(]+?)=>/,
        Vf = /^[^\(]*\(\s*([^\)]*)\)/m,
        Bg = /,/,
    ...
    var Qd = O("$animate"),
        ...
        Ye = function() { this.$get = ["$$rAF", "$q", "$$AnimateRunner", function(a, b, d) {
                return function(b, e) {
    ...
    var Vc = /^((?:x|data)[\:\-_])/i,
        $f = O("$controller"),
        bd = /^(\S+)(\s+as\s+([\w$]+))?$/,
        hf = function() { this.$get = ["$document", function(a) {
    ...
    var Eg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
        ...
        Fg = {
            ...
            host: Fb("$$host"),
            port: Fb("$$port"),
            path: ld("$$path", function(a) { a = null !== a ? a.toString() : "";
            ...
            switch (a.type) {
                ...
                case s.CallExpression:
                    return g = [], q(a.arguments, function(a) { g.push(f.recurse(a)) }), a.filter && (e = this.$filter(a.callee.name)), a.filter || (e = this.recurse(a.callee, !0)), a.filter ? function(a, c, d, f) {
                        ...
                        return b ? { context: void 0, name: void 0, value: a } : a } : function(a,
                        c, d, n) {
                        var m = e(a, c, d, n),
                            r;
                        if (null != m.value) { sa(m.context, f.expression);
    ...
    q(ad, function(a, b) { tb[b] = function() {
            return { priority: 100, link: function(a, c, e) {
                    if ("ngPattern" === b && "/" == e.ngPattern.charAt(0) && (c = e.ngPattern.match(zg))) { e.$set("ngPattern", new RegExp(c[1], c[2]));
                        return }
                    ...
                    compile: function(d, f) {
                        ...
                        return {
                            pre: function(a, d, e, f) {
                                var m = f[0];
                                if (!("action" in e)) {
                                    var r = function(b) { a.$apply(function() { m.$commitViewValue();
                                            m.$setSubmitted() });
                                        b.preventDefault() };
    ...
    var De = ["$animate", "$compile", function(a,
        ...
        Ue = function() {
            return {
                ...
                controller: ["$scope", "$attrs", function(a, b) {
                    ...
                    x(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = V(this.$options.updateOn.replace(Ng, function() { d.$options.updateOnDefault = !0;
                ...
                return {
                    ...
                    getOptions: function() {
                        ...
                        return { items: a, selectValueMap: b, getOptionFromViewValue: function(a) {
                                return b[t(a)] }, getViewValueFromOption: function(a) {
                ...
                link: {
                    ...
                    post: function(d, h, k, l) {
                        ...
                        function m() {
                            ...
                            u.items.forEach(function(a) {
                                ...
                                if (x(a.group)) { b = d[a.group];
                                    ...
                                    var c = e.cloneNode(!1) } else b = E, c = e.cloneNode(!1);
                                b.appendChild(c);
                                n(a, c)
                            });
                            h[0].appendChild(E);
                        ...
                        v ? (s.$isEmpty = function(a) {
                            return !a || 0 === a.length }, r.writeValue = function(a) {
                            ...
                            return b }, I.trackBy && d.$watchCollection(function() {
                            if (K(s.$viewValue)) return s.$viewValue.map(function(a) {
                                return I.getTrackByValue(a) }) }, function() { s.$render() })) : (r.writeValue = function(a) {
                            ...
                            return a && !a.disabled ? (t || w.remove(), z.remove(), u.getViewValueFromOption(a)) : null }, I.trackBy && d.$watch(function() {
                            return I.getTrackByValue(s.$viewValue) }, function() { s.$render() }));
            ...
            return {
                ...
                link: function(d, c, e, f) {
                    ...
                    d.$watch(e.ngSwitch || e.on, function(c) {
                        ...
                        l.length = 0;
                        (g = f.cases["!" +
                            c] || f.cases["?"]) && q(g, function(c) { c.transclude(function(d, e) { l.push(e);
                                var f = c.element;
        ...
        Qg = O("ngTransclude"),
        Pe = La({ restrict: "EAC", link: function(a, b, d, c, e) { d.ngTransclude === d.$attr.ngTransclude && (d.ngTransclude = "");
                ...
                link: {
                    pre: function(a, b, d, c) {
                        ...
                        if (e) {
                            ...
                            if (d.multiple) { f.readValue = function() {
                                    var a = [];
            ...
            return {
                ...
                link: function(a, b, d, c) {
                    c && (d.required = !0, c.$validators.required = function(a, b) {
                        return !d.required || !c.$isEmpty(b) }, d.$observe("required",
                        function() { c.$validate() }))
                }
            }
        },
        Ec = function() {
            return { restrict: "A", require: "?ngModel", link: function(a, b, d, c) {
                    if (c) {
                        ...
                        d.$observe("pattern", function(a) { F(a) && 0 < a.length && (a = new RegExp("^" + a + "$"));
